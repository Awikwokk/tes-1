...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Paiz ]')}\n\n${chalk.red('Jem-Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@fz_frdnd')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+6281249086533')}\n${chalk.red('Donate')} : ${chalk.white('081249086533 ( Ovo/Pulsa/Dana )')}\n`))
}
...
const connectToWhatsApp = async () => {
	...
	const conn = makeWASocket({
            ...
            auth: state,
            browser: ["Jem-Bot Multi Device", "Safari", "3.0"],
